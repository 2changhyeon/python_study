...
#이번 베이스라인에서는 과제명 뿐만 아니라 요약문_연구내용, 연구목표, 한글키워드 까지 모델에 학습시켜보겠습니다.
...
# 학습과 eval 시작
history = cls_model.fit(train_inputs, train_labels, epochs=1, batch_size=16,
...
sample_submission.to_csv('bert_baseline0729.csv', index=False)
