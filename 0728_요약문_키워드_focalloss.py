# -*- coding: utf-8 -*-
"""
Created on Wed Jul 28 18:48:16 2021
...
# 학습과 eval 시작
history = cls_model.fit(train_inputs, train_labels, epochs=10, batch_size=10,
...
sample_submission.to_csv('bert_baseline0730_keyword_focalloss.csv', index=False)
