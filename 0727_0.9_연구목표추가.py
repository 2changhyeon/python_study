...
train=train[['과제명', '요약문_연구내용','요약문_연구목표','요약문_한글키워드','요약문_영문키워드','label']]
test=test[['과제명', '요약문_연구내용','요약문_연구목표','요약문_한글키워드','요약문_영문키워드']]
...
train['data']=train['과제명']+train['요약문_연구내용']+train['요약문_연구목표']+train['요약문_한글키워드']+train['요약문_영문키워드']
test['data']=test['과제명']+test['요약문_연구내용']+test['요약문_연구목표']+test['요약문_한글키워드']+test['요약문_영문키워드']
...
# 학습과 eval 시작
history = cls_model.fit(train_inputs, train_labels, epochs=10, batch_size=8,
...
sample_submission.to_csv('bert_baseline0728_keyword_focalloss.csv', index=False)
